...
let country=(data,Gdata)=>{
   ...
   <div class="infoItem"><h5> Population : ${data.population}</h5></div>
   <div class="infoItem"><h5>Region : ${data.region}</h5></div>
   <div class="infoItem"><h5> Sub Region : ${data.subregion}</h5></div>
   <div class="infoItem"><h5> Capital : ${data.capital ? data.capital:`no capital`}</h5></div>
   </div>
  
   <div class="x2-column">
   <div class="infoItem"><h5> Top Level Domain : ${data.topLevelDomain ? data.topLevelDomain: `<button>no info</button>`}</h5></div>
       
   <div class="infoItem"><h5> Currencies : ${data.currencies ? data.currencies[0].name:`<button>no currencies</button>`}</h5></div>
